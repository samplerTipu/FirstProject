...
<body>
	...
	<div class="container mt-5">
		...
		<form action="add" method="post">
			...
			<h3 class="text-success text-center"><%=(String)request.getAttribute("status")!=null?(String)request.getAttribute("status"):""%></h3>

			<div class="form-group">
				<label for="emp_ID">Employee ID</label> <input type="text"
					class="form-control" id="emp_ID" aria-describedby="empHelp"
					placeholder="Enter Id" name="emp_ID" required="required">
